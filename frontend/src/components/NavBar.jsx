...
//         <Link to='/'>
//             <img src={assets.unveilleather} className='w-36' alt="unveilleather" />
//         </Link>
...
const NavBar = () => {
    ...
    return (
        <div className='flex items-center justify-between py-5 font-medium relative'>
            ...
            {/* Sidebar menu for smaller screens - Fixed 'fixed' position and z-index */}
            <div className={`fixed top-0 right-0 bottom-0 z-50 overflow-hidden bg-white transition-all duration-300 ${visible ? 'w-full' : 'w-0'}`}>
                <div className='flex flex-col text-gray-600 h-full'>
                    ...
                    <NavLink onClick={() => setVisible(false)} className='py-3 pl-6 border-b hover:bg-gray-50' to='/orders'>ORDERS</NavLink>
                </div>
            </div>
        </div>
    )
