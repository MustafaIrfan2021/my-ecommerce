...
//     // Default method 'verifone' rakha hai taake card payment highlight ho
//     const [method, setMethod] = useState('verifone');
//     const { navigate, backendUrl, token, cartItems, setCartItems, getCartAmount, delivery_fee, products } = useContext(ShopContext);
...
//                 case 'verifone':
//                     // Verifone ka API call jo aapke backend par jayega
//                     const responseVerifone = await axios.post(backendUrl + '/api/order/verifone', orderData, { headers })
//                     if (responseVerifone.data.success) {
//                         // Verifone aapko ek checkout_url dega jahan customer card details dalega
//                         window.location.replace(responseVerifone.data.checkout_url)
//                     } else {
//                         toast.error(responseVerifone.data.message)
//                     }
...
//                     <Title text1={'PAYMENT'} text2={'METHODS'} />
//                     <div className='flex flex-col gap-3 lg:flex-row'>
//                         {/* Verifone Credit/Debit Card Option */}
//                         <div onClick={() => setMethod('verifone')} className='flex items-center gap-3 p-2 px-3 border cursor-pointer'>
//                             <p className={`min-w-3.5 h-3.5 border rounded-full ${method === 'verifone' ? 'bg-green-600' : ''}`}></p>
//                             <p className='mx-4 text-xs font-bold text-gray-700 uppercase'>Credit / Debit Card</p>
//                             {/* Verifone approval ke liye card icons add karna acha hota hai */}
//                         </div>
            ...
            <div className='mt-8'>
                ...
                <div className='mt-12'>
                    ...
                    <div className='flex flex-col gap-3 lg:flex-row'>
                        ...
                        {/* Verifone Credit/Debit Card Option with Icons */}
                        <div onClick={() => setMethod('verifone')} className='flex items-center gap-3 p-2 px-3 border cursor-pointer min-w-[250px]'>
                            <p className={`min-w-3.5 h-3.5 border rounded-full ${method === 'verifone' ? 'bg-green-600' : ''}`}></p>
                            <div className='flex flex-col gap-1'>
                                <p className='text-xs font-bold text-gray-700 uppercase'>Credit / Debit Card</p>
                                <div className='flex gap-2'>
                                    <img className='h-4' src={assets.visa} alt="Visa" />
                                    <img className='h-4' src={assets.Mastercard_logo} alt="Mastercard" />
                                    <img className='h-4' src={assets.Mastercard_logo} alt="Mastercard" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div onClick={() => setMethod('cod')} className='flex items-center gap-3 p-2 px-3 border cursor-pointer'>
                            <p className={`min-w-3.5 h-3.5 border rounded-full ${method === 'cod' ? 'bg-green-600' : ''}`}></p>
                            <p className='mx-4 text-sm font-medium text-gray-500 uppercase'>Cash on Delivery</p>
                        </div>
                    </div>
